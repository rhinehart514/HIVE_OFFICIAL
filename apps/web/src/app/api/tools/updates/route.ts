...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error(
      `Error processing tool update at /api/tools/updates`,
...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error(
      `Error getting tool updates at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.error(
      `Error syncing tool state at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    logger.error(
      `Error cleaning up tool updates at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
...
async function verifyToolUpdatePermission(
  ...
  try {
    ...
    logger.error(
      `Error verifying tool update permission at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
    return false;
  }
...
async function verifyToolAccess(
  ...
  try {
    ...
    logger.error(
      `Error verifying tool access at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
    return false;
  }
...
async function getToolUsers(toolId: string, deploymentId?: string, spaceId?: string, campusId?: string): Promise<string[]> {
  try {
    ...
    logger.error(
      `Error getting tool users at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
    return [];
  }
...
async function getSpaceMembers(spaceId: string, campusId?: string): Promise<string[]> {
  try {
    ...
    logger.error(
      `Error getting space members at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
    return [];
  }
...
async function getNextSequenceNumber(toolId: string, deploymentId?: string): Promise<number> {
  try {
    ...
    logger.error(
      `Error getting next sequence number at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
...
async function getToolStateSnapshot(toolId: string, deploymentId?: string): Promise<ToolStateSnapshot | null> {
  try {
    ...
    logger.error(
      `Error getting tool state snapshot at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
    return null;
  }
...
async function updateToolStateSnapshot(updateEvent: ToolUpdateEvent, currentSnapshot?: ToolStateSnapshot | null): Promise<void> {
  try {
    ...
    logger.error(
      `Error updating tool state snapshot at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
  }
}
...
async function createToolStateSnapshot(
  ...
  try {
    ...
    logger.error(
      `Error creating tool state snapshot at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
  }
}
...
async function broadcastToolUpdate(updateEvent: ToolUpdateEvent): Promise<void> {
  try {
    ...
    logger.error(
      `Error broadcasting tool update at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
  }
}
...
async function notifyAffectedUsers(updateEvent: ToolUpdateEvent, userIds: string[]): Promise<void> {
  try {
    ...
    logger.error(
      `Error notifying affected users at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
  }
}
...
async function initializeAckTracking(updateEvent: ToolUpdateEvent): Promise<void> {
  try {
    ...
    logger.error(
      `Error initializing ack tracking at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
  }
}
...
async function getToolSyncStatus(toolId: string, deploymentId?: string, _userId?: string): Promise<Record<string, unknown>> {
  try {
    ...
    logger.error(
      `Error getting tool sync status at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
    return {
      status: 'error',
...
async function resolveToolStateConflict(
  ...
  try {
    ...
    logger.error(
      `Error resolving tool state conflict at /api/tools/updates`,
      { error: error instanceof Error ? error.message : String(error) }
    );
    throw error;
  }
