...
const SearchSpacesSchema = z.object({
  ...
  // Use canonical categories: student_organizations, university_organizations, greek_life, campus_living, hive_exclusive
  category: z
    .enum(["student_organizations", "university_organizations", "greek_life", "campus_living", "hive_exclusive"])
    .optional(),
