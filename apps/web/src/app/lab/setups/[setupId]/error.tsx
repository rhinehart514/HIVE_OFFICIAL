...
export default function SetupDetailError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Setup detail error', {
      digest: error.digest,
      component: 'SetupDetailErrorBoundary',
    }, error);
  }, [error]);
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mb-6 text-sm text-muted-foreground">
          We had trouble loading this setup. It may have been deleted or you may not have access.
        </p>
