...
export default function SpacesBrowseError({
  ...
  useEffect(() => {
    logger.error('Spaces browse error boundary triggered', {
      digest: error.digest,
      component: 'SpacesBrowseErrorBoundary',
    }, error);
  }, [error]);
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="mx-auto max-w-md text-center">
        ...
        <h2 className="mb-2 text-xl font-semibold text-foreground">
          Unable to browse spaces
        </h2>

        <p className="mb-6 text-sm text-muted-foreground">
          We had trouble loading the spaces directory. This might be a temporary issue.
        </p>
