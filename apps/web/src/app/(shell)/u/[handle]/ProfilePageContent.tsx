  ...
  return (
    <div className="flex items-center justify-center py-32 px-6">
      <div className="text-center max-w-sm">
        ...
        <Link href="/discover" className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/[0.05] text-white/50 text-sm font-medium hover:bg-white/[0.10]">
          Go home
        </Link>
      </div>
    </div>
