...
export default function ToolDeploymentError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Tool deployment error', {
      digest: error.digest,
      component: 'ToolDeploymentErrorBoundary',
    }, error);
  }, [error]);
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mb-6 text-sm text-muted-foreground">
          We had trouble loading this tool. It may have been removed or you may not have access.
        </p>
