...
export default function SpaceToolsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Space tools error', {
      digest: error.digest,
      component: 'SpaceToolsErrorBoundary',
    }, error);
  }, [error]);
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mb-6 text-sm text-muted-foreground">
          We had trouble loading the space tools. This might be a temporary issue.
        </p>
