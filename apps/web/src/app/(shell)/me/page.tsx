...
function ProfilePageSkeleton() {
  return (
    <div className="w-full px-4 md:px-6 pt-8 pb-24 md:pb-8">
      ...
      <div className="mx-auto max-w-2xl px-4 pt-16">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-8 p-6 rounded-2xl bg-white/[0.03] border border-white/[0.05] max-w-sm w-full">
            ...
            <Link
              href="/me/edit"
              className="inline-flex items-center justify-center w-full px-5 py-2.5 bg-white text-black text-sm font-semibold rounded-full hover:bg-white/90 transition-colors duration-100"
            >
              Set up profile
            </Link>
          </div>
