  ...
  const content = (
    ...
    >
      ...
      <div className="flex-shrink-0 flex items-center justify-between px-4 py-3 bg-[var(--color-bg-void,#050504)] border-b border-white/[0.05]">
        ...
        >
          {isProcessing ? (
            <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full " aria-hidden="true" />
          ) : (
      ...
      <div className="flex-shrink-0 px-6 pb-6 pt-2 bg-[var(--color-bg-void,#050504)]">
        <motion.button
          ...
          className="w-full h-12 bg-white text-black font-semibold rounded-full hover:bg-white/90 transition-colors duration-100 disabled:opacity-50"
        >
