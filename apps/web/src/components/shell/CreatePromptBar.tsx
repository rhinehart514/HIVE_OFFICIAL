  ...
  const content = (
    <div className="w-full">
      ...
      >
        ...
        <button
          type="submit"
          className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white text-black transition-colors duration-150 hover:brightness-95 focus-visible:outline-none focus-visible:outline-2 focus-visible:outline-[#FFD700]"
