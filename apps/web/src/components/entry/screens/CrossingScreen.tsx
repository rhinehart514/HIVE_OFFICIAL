...
/**
 * CrossingScreen - Interests selection
 *
 * Phase 4 of Entry: "What drives you?"
 * Purpose: Connect user to communities via interests. Determines discovery.
 */
...
interface CrossingScreenProps {
  entry: UseEntryReturn;
}

export function CrossingScreen({ entry }: CrossingScreenProps) {
