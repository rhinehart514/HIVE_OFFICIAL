  ...
  return (
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        {(entry.proveStep === 'code' || entry.proveStep === 'waitlist') && !entry.waitlistSuccess && (
          <button
          ...
          <>
            ...
            >
              ...
              <span className="text-[11px] uppercase tracking-[0.3em] text-white/30">
                {entry.proveStep === 'email' ? 'Prove yourself' : 'Verify'}
              </span>
            </motion.div>
      ...
      <AnimatePresence mode="wait">
        ...
        {entry.proveStep === 'waitlist' && entry.waitlistSchool && (
          <motion.div
            key="waitlist"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
