    ...
    >
      ...
      <div className="relative z-10">
        ...
        <motion.button
          ...
          className="group inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#FFD700] text-black font-semibold text-sm hover:bg-[#FFD700]/90 transition-colors duration-100"
