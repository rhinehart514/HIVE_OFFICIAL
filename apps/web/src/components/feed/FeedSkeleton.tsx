      ...
      <section>
        ...
        <div className="flex gap-2.5 overflow-hidden">
          {[0, 1].map((i) => (
            <div
              key={i}
              className="shrink-0 w-[260px] rounded-xl bg-white/[0.02] border border-white/[0.04] overflow-hidden"
            >
      ...
      <section>
        ...
        <div className="space-y-2">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="rounded-xl bg-white/[0.02] border border-white/[0.04] overflow-hidden flex"
            >
              <div className="w-24 min-h-[88px] bg-white/[0.03] animate-pulse" />
              <div className="flex-1 p-3 space-y-2">
                ...
                <div className="flex gap-2 mt-1">
                  <div className="h-6 w-14 bg-white/[0.04] rounded-lg animate-pulse" />
