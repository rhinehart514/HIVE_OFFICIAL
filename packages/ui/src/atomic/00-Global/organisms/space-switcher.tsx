    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {space.isPinned && (
            <PinIcon className="text-[#FFD700]/60 flex-shrink-0" />
          )}
        </div>
                  ...
                  <div className="py-8 text-center">
                    ...
                    {spaces.length === 0 && onCreateSpace && (
                      <button
                        ...
                        className="mt-2 text-[#FFD700] text-sm hover:underline"
                      >
              ...
              <div className="p-3 border-t border-white/[0.06] flex items-center justify-between">
                ...
                {onCreateSpace && (
                  <motion.button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#FFD700]/10 text-[#FFD700] text-sm font-medium hover:bg-[#FFD700]/20 transition-colors"
