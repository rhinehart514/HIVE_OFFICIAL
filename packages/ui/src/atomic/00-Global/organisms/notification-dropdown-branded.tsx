...
function NotificationItem({ text, time, unread }: NotificationItemProps) {
  return (
    <div className="flex gap-3 p-2 rounded-lg hover:bg-white/[0.04] transition-colors cursor-pointer">
      {unread && (
        <div className="w-2 h-2 rounded-full bg-[#FFD700] mt-1 flex-shrink-0" />
      )}
