...
// Re-export types from the canonical source (breaks circular dep with element-renderers/registry)
export type {
  ElementTier,
  DataSource,
  ElementSharedState,
...
import type { ElementTier, DataSource, ElementProps } from './element-types';
