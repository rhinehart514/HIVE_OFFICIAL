...
var colors_prd_aligned_1 = require("./src/colors-prd-aligned");
var radius_prd_aligned_1 = require("./src/radius-prd-aligned");
var tailwind_config_1 = require("./src/tailwind-config");
var masterConfig = {
    darkMode: 'class',
    ...
    theme: {
        ...
        extend: {
            ...
            colors: __assign(__assign(__assign({}, tailwind_config_1.hiveTailwindColors), colors_prd_aligned_1.prdTailwindColors), { 
                ...
                // HIVE Branded Colors
                'hive-brand-primary': '#FFD700', 'hive-brand-secondary': '#1a1a1a', 'hive-background': '#000000', 'hive-background-overlay': '#111111', 'hive-surface': '#1a1a1a', 'hive-text-primary': '#ffffff', 'hive-text-secondary': '#cccccc', 'hive-text-mutedLight': '#888888', 'hive-border-default': '#333333', 'hive-gold': '#FFD700', 'hive-obsidian': '#0c0c0c' }),
            // RADIUS SYSTEM
            borderRadius: __assign(__assign({}, radius_prd_aligned_1.prdTailwindRadius), { lg: 'var(--radius)', md: 'calc(var(--radius) - 2px)', sm: 'calc(var(--radius) - 4px)' }),
            // TYPOGRAPHY SYSTEM
            fontFamily: {
