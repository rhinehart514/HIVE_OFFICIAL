...
const tailwind_config_unified_1 = require("./src/tailwind-config-unified");
...
const masterConfig = {
  ...
  theme: {
    extend: {
      ...tailwind_config_unified_1.hiveTailwindConfig,
      colors: {
        ...tailwind_config_unified_1.hiveTailwindConfig.colors,
