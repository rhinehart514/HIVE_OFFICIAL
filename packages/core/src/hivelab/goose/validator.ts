...
export const ELEMENT_PORTS: Record<string, { outputs: string[]; inputs: string[] }> = {
  ...
  'listing-board': { outputs: ['listings', 'listingCount', 'claimedCount'], inputs: [] },
  'match-maker': { outputs: ['matches', 'poolSize'], inputs: [] },
  'workflow-pipeline': { outputs: ['requests', 'stageCount'], inputs: [] },
  'data-table': { outputs: ['rows', 'rowCount'], inputs: [] },
  'custom-block': { outputs: [], inputs: [] },
  'photo-gallery': { outputs: ['photos'], inputs: [] },
  'progress-indicator': { outputs: ['value'], inputs: [] },
  'directory-list': { outputs: [], inputs: ['items'] },
  'qr-code-generator': { outputs: [], inputs: [] },
  'signup-sheet': { outputs: ['signups', 'slotCounts'], inputs: [] },
  'checklist-tracker': { outputs: ['completions', 'progress'], inputs: [] },
  'dining-picker': { outputs: ['selectedDining'], inputs: [] },
  'study-spot-finder': { outputs: ['selectedSpot'], inputs: [] },
  'personalized-event-feed': { outputs: ['events'], inputs: [] },
  'announcement': { outputs: ['announcementId', 'viewCount'], inputs: ['content', 'spaceId'] },
  'availability-heatmap': { outputs: ['selectedSlot', 'bestTimes'], inputs: ['spaceId'] },
